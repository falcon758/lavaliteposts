...
{
    public function transform(\Posts\Posts\Models\Channel $channel)
    {
        return [
            ...
            'url'               => [
                'public'    => trans_url('posts/'.$channel->getPublicKey()),
                'user'      => guard_url('posts/channel/'.$channel->getRouteKey()),
            ], 
