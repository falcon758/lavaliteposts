        ...
        <div class="col-xs-12">
            ...
            <div class="card">
                <div class="card-header with-sub" data-background-color="red">
                    <div class="row">
                        <div class="col-sm-11 title-main">
                            ...
                            <h4 class="title">{{ trans('app.create')  }} post</h4>
                            <p class="sub-title">{{ trans('app.add')  }} post here...</p>
                        </div>
                        <div class="col-sm-1">
                ...
                <div class="card-content">                
                    ...
                    @include('posts::user.post.partial.entry', ['mode' => 'create'])
                </div>
