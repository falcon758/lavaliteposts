                    <div class="list-view">
                        ...
                        <div class="card list-view-media"  id="{!! $channel->getRouteKey() !!}">
                            <div class="card-block">
                                <div class="media">
                                    <a class="media-left" href="{!! trans_url('postbuffer') !!}/{!! $channel->getPublicKey() !!}" target="_blank">
                                        <img class="media-object card-list-img" src="http://via.placeholder.com/150x100/FC0079/FFF?text=ADVT">
                                    </a>
                                    <div class="media-body">
                                        <div class="heading">
                                            <h3><a  href="{!! trans_url('postbuffers') !!}/{!! $channel->getPublicKey() !!}" target="_blank">{!! $channel->name !!}</a></h3>
                                            <h6>{!! $channel->email !!}</h6>
                                            <div class="status">
                                        ...
                                        <div class="actions">
                                            ...
                                            <a href="{!! guard_url('postbuffer/channel') !!}/{!! $channel->getRouteKey() !!}" class="text-primary" data-toggle="tooltip" data-placement="left" title="Edit" data-action="EDIT" ><i class="icon-eye"></i></a>
