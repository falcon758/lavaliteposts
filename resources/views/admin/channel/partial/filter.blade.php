...
<div class="container-fluid">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[user_tye]" class="col-sm-2 control-label">
                                        {!! trans('posts::channel.label.user_tye')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[seller_id]" class="col-sm-2 control-label">
                                        {!! trans('posts::channel.label.seller_id')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[seller_id]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[amount]" class="col-sm-2 control-label">
                                        {!! trans('posts::channel.label.amount')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[tax_amount]" class="col-sm-2 control-label">
                                        {!! trans('posts::channel.label.tax_amount')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[tax_amount]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[tax_type]" class="col-sm-2 control-label">
                                        {!! trans('posts::channel.label.tax_type')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[tax_type]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[type]" class="col-sm-2 control-label">
                                        {!! trans('posts::channel.label.type')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[bank_ref]" class="col-sm-2 control-label">
                                        {!! trans('posts::channel.label.bank_ref')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[bank_ref]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[details]" class="col-sm-2 control-label">
                                        {!! trans('posts::channel.label.details')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[details]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[date_from]" class="col-sm-2 control-label">
                                        {!! trans('posts::channel.label.date_from')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[date_from]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[date_to]" class="col-sm-2 control-label">
                                        {!! trans('posts::channel.label.date_to')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[date_to]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[commission]" class="col-sm-2 control-label">
                                        {!! trans('posts::channel.label.commission')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[commission]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            </div>
